 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_newsport_config']['new']        		= array('New config', 'Create a new config');
$GLOBALS['TL_LANG']['tl_newsport_config']['show']       		= array('Config details', 'Show config ID %s');
